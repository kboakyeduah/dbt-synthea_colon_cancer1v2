...
SELECT
    ...
    , e.encounter_start_datetime::timestamp AS death_datetime
    , 32817::integer AS death_type_concept_id
    , srctostdvm.target_concept_id::integer AS cause_concept_id
    , e.encounter_reason_code::varchar(50) AS cause_source_value
    , srctostdvm.source_concept_id::integer AS cause_source_concept_id
